...
//        System.out.println(entryList);
    ...
    {
        String content = "做一个网站，按我们要求的排版和后台功能，在国外服务器可以用。";
        System.out.println(new TextRankKeyword2().getKeyword("", content));
