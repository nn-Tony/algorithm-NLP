...
import com.alg.tony.lda.Corpus;
import com.alg.tony.lda.LdaGibbsSampler;
import com.alg.tony.lda.LdaUtil;

/**
 * @author tony
 */
public class LDA_TestCorpus extends TestCase
{
    ...
    public void testAll() throws Exception
    {
        ...
        Corpus corpus = Corpus.load("./modelfile/lda/mini/");//data/mini
        ...
        int[] document = Corpus.loadDocument("./modelfile/lda/mini/军事_510.txt", corpus.getVocabulary());
